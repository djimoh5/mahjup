...
export type GeminiModel = 'gemini-3.1-pro-preview' | 'gemini-3.1-flash-image' | 'gemini-3.5-flash';
...
export var AIModels: AIModel[] = ['gpt-5.4', 'gpt-5.4-mini', 'gpt-5.4-nano', 'gemini-3.1-pro-preview', 'gemini-3.1-flash-image', 'gemini-3.5-flash', 'claude-opus-4-7', 'claude-sonnet-4-6', 'claude-haiku-4-5'];
