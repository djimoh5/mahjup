...
export type GeminiModel = 'gemini-3-pro-preview' | 'gemini-3-pro-image-preview' | 'gemini-2.5-flash' | 'gemini-3.5-flash' | 'gemini-3.1-pro-preview';
...
export var AIModels: AIModel[] = ['gpt-5.2', 'gpt-5-mini', 'gpt-5-nano', 'gemini-3-pro-preview', 'gemini-3-pro-image-preview', 'gemini-2.5-flash', 'gemini-3.5-flash', 'claude-opus-4-7', 'claude-sonnet-4-6', 'claude-haiku-4-5'];
